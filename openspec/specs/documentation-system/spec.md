...
Define the requirements for the VoiceInput repository documentation so that it provides clear navigation, accurate technical guidance, actionable troubleshooting, and maintainable structure for both users and maintainers.
