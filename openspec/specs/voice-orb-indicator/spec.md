...
Defines the visual behavior and layout constraints for the floating-window voice recording indicator. The indicator presents recording activity as a premium circular orb whose motion, color, and glow respond continuously to live audio RMS input.
